...
function ContactUs() {
  ...
  return (
    <div id='Contact' className="py-16 flex flex-col md:justify-between md:flex-row bg-zinc-50 mx-auto px-4 md:px-24">
      ...
      <div className="flex flex-col justify-center space-y-6 bg-white rounded-lg p-5 md:p-9 shadow-md">
        <div>
          <p className="text-lg font-semibold text-gray-600 text-left mb-2 mt-4 md:mt-0 max-w-lg">
          Contact us to start your project or get your questions answered. We're here to help elevate your ideas!          </p>
