...
import Slice from '../Assets/splice.png';

function Splice() {
  return (
<div id='Home' className='relative flex justify-between items-center mt-[85px] h-[320px] md:h-[429px]  mx-auto bg-cover bg-center p-10  text-center'>
