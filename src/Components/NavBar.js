...
function NavBar() {
  ...
  return (
    <nav className='fixed top-0 left-0 right-0 flex md:justify-between items-center px-2 md:px-20 py-4 md:py-5 bg-white shadow-sm border-b z-50'>
      <div>
      ...
      <div className=' mx-auto md:mx-0 flex space-x-5 md:space-x-14 font-normal'>
